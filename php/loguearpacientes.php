...
$un = "SELECT Username_pacientes FROM users_pacientes WHERE Email_pacientes = '$usuario'";

$q = "SELECT COUNT(*) as contar from users_pacientes where Email_pacientes = '$usuario' and password_paciente = '$clave' ";
