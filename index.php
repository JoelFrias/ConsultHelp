                ...
                <section id="hero">
                        <div class="hero container">
                            <div>
                                ...
                                <a href="pacientes.php#Agregar" type="button" class="cta">Añadir Paciente</a><br>
                                <a href="consultas.php#crear" type="button" class="cta">Crear Nueva Consulta</a><br>
                                <a href="tabla.php#tabla1" type="button" class="cta">Ver Consultas</a>
